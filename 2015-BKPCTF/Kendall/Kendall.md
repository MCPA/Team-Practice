...
When running the binary, make sure you create the required files for the binary to function. Next, in the same directory ```touch dhcp.log``` and ```touch password.txt```.
